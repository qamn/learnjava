...
public class DataType {
    ...
    int noPrivate; //默认并不是private，而是包内可访问
    public boolean isPublic; // public是任何地方都能访问
    final boolean isFinal = true;
    static boolean isStatic = true; //static是类变量，不属于某个对象，所以static方法不能访问某个对象的成员，因为没有this指针
